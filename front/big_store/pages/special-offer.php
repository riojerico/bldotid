							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b " data-id="1" data-name="Moong" data-summary="summary 1" data-price="1.50" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of.png">Add to Cart</button>
										</div>
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="clearfix"></div>
												...
												<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="2" data-name="Sunflower Oil" data-summary="summary 2" data-price="9.00" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of1.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="4" data-name="Soya Chunks" data-summary="summary 4" data-price="3.50" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of3.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="5" data-name="Lays" data-summary="summary 5" data-price="0.70" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of4.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="6" data-name="Kurkure" data-summary="summary 6" data-price="0.70" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of5.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="7" data-name="Popcorn" data-summary="summary 7" data-price="1.00" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of6.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="8" data-name="Nuts" data-summary="summary 8" data-price="3.50" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of7.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
								...
								<a href="#" data-toggle="modal" data-target="#myModal9" class="offer-img">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="9" data-name="Banana" data-summary="summary 9" data-price="1.50" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of8.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="10" data-name="Onion" data-summary="summary 10" data-price="0.70" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of9.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="11" data-name="Bitter Gourd" data-summary="summary 11" data-price="1.00" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of10.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="12" data-name="Apples" data-summary="summary 12" data-price="3.50" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of11.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
								...
								<a href="#" data-toggle="modal" data-target="#myModal13" class="offer-img">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="13" data-name="Honey" data-summary="summary 13" data-price="6.00" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of12.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m ">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="14" data-name="Chocos" data-summary="summary 14" data-price="4.50" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of13.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-m ">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="15" data-name="Oats" data-summary="summary 15" data-price="3.50" data-quantity="1" data-image="<?php echo $base_url ?>/assets/images/of14.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
